...
locals {
        ...
        arc_values = {
            ...
            "authSecret.github_app_id" = var.github_app_id
            "authSecret.github_app_installation_id" = var.github_app_installation_id
            "authSecret.github_app_private_key" = var.github_app_private_key_path
